...
export class LeafletDirective implements OnChanges, OnDestroy, OnInit {
    ...
    @Input('leafletFitBoundsOptions') fitBoundsOptions =
    ...
    @Output('leafletDoubleClick') onDoubleClick =
        new EventEmitter<LeafletMouseEvent>();
    @Output('leafletMouseDown') onMouseDown =
        new EventEmitter<LeafletMouseEvent>();
    @Output('leafletMouseUp') onMouseUp = new EventEmitter<LeafletMouseEvent>();
    @Output('leafletMouseMove') onMouseMove =
        new EventEmitter<LeafletMouseEvent>();
    @Output('leafletMouseOver') onMouseOver =
        new EventEmitter<LeafletMouseEvent>();
    @Output('leafletMouseOut') onMouseOut =
        new EventEmitter<LeafletMouseEvent>();

    // Map Move Events
    @Output('leafletMapMove') onMapMove = new EventEmitter<LeafletEvent>();
    @Output('leafletMapMoveStart') onMapMoveStart =
        new EventEmitter<LeafletEvent>();
    @Output('leafletMapMoveEnd') onMapMoveEnd =
        new EventEmitter<LeafletEvent>();

    // Map Zoom Events
    @Output('leafletMapZoom') onMapZoom = new EventEmitter<LeafletEvent>();
    @Output('leafletMapZoomStart') onMapZoomStart =
        new EventEmitter<LeafletEvent>();
    @Output('leafletMapZoomEnd') onMapZoomEnd =
        new EventEmitter<LeafletEvent>();
    ...
    private addMapEventListeners() {
        const registerEventHandler = (
            eventName: string,
            handler: (e: LeafletEvent) => any,
        ) => {
            this.map.on(eventName, handler);
        };

        // Add all the pass-through mouse event handlers
        registerEventHandler('click', (e: LeafletMouseEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onClick, e),
        );
        registerEventHandler('dblclick', (e: LeafletMouseEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onDoubleClick, e),
        );
        registerEventHandler('mousedown', (e: LeafletMouseEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMouseDown, e),
        );
        registerEventHandler('mouseup', (e: LeafletMouseEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMouseUp, e),
        );
        registerEventHandler('mouseover', (e: LeafletMouseEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMouseOver, e),
        );
        registerEventHandler('mouseout', (e: LeafletMouseEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMouseOut, e),
        );
        registerEventHandler('mousemove', (e: LeafletMouseEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMouseMove, e),
        );

        registerEventHandler('zoomstart', (e: LeafletEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMapZoomStart, e),
        );
        registerEventHandler('zoom', (e: LeafletEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMapZoom, e),
        );
        registerEventHandler('zoomend', (e: LeafletEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMapZoomEnd, e),
        );
        registerEventHandler('movestart', (e: LeafletEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMapMoveStart, e),
        );
        registerEventHandler('move', (e: LeafletEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMapMove, e),
        );
        registerEventHandler('moveend', (e: LeafletEvent) =>
            LeafletUtil.handleEvent(this.zone, this.onMapMoveEnd, e),
        );

    ...
    implements DoCheck, OnDestroy, OnInit
{
    ...
    @Output('leafletLayersControlReady') layersControlReady =
        new EventEmitter<Control.Layers>();
    ...
    protected updateLayers() {
        ...
        if (null != map && null != layersControl) {
            ...
            if (
                null != this.baseLayersDiffer &&
                null != this.layersControlConfigValue.baseLayers
            ) {
                const changes = this.baseLayersDiffer.diff(
                    this.layersControlConfigValue.baseLayers,
                );
            ...
            if (
                null != this.overlaysDiffer &&
                null != this.layersControlConfigValue.overlays
            ) {
                const changes = this.overlaysDiffer.diff(
                    this.layersControlConfigValue.overlays,
                );

...
If you plan to show more than just baselayers, you should use the more advanced layers controls described in _Advanced Layer Management_ below.

For an example of the basic map setup, you should check out the _Simple Base Layers_ demo.
...
For an example of using the layers controls, you should check out the _Layers and Layer Controls_ demo.
...
For more details, you should check out the _Layers and ngFor_ demo.

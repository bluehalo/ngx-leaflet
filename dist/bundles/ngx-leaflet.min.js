...
/**
     ...
     */
e.prototype.doResize=function(){var e=this;
// Invalidate the map size to trigger it to update itself
this.zone.runOutsideAngular(function(){e.map.invalidateSize({})})},
/**
     * Manage a delayed resize of the component
     */
e.prototype.delayResize=function(){null!=this.resizeTimer&&clearTimeout(this.resizeTimer),this.resizeTimer=setTimeout(this.doResize.bind(this),200)},
/**
     * Set the view (center/zoom) all at once
     * @param center The new center
     * @param zoom The new zoom level
     */
e.prototype.setView=function(e,t){var r=this;this.map&&null!=e&&null!=t&&this.zone.runOutsideAngular(function(){r.map.setView(e,t,r.zoomPanOptions)})},
/**
     * Set the map zoom level
     * @param zoom the new zoom level for the map
     */
e.prototype.setZoom=function(e){var t=this;this.map&&null!=e&&this.zone.runOutsideAngular(function(){t.map.setZoom(e,t.zoomOptions)})},
/**
     * Set the center of the map
     * @param center the center point
     */
e.prototype.setCenter=function(e){var t=this;this.map&&null!=e&&this.zone.runOutsideAngular(function(){t.map.panTo(e,t.panOptions)})},
/**
     * Fit the map to the bounds
     * @param center the center point
     */
e.prototype.setFitBounds=function(e){var t=this;this.map&&null!=e&&this.zone.runOutsideAngular(function(){t.map.fitBounds(e,t.fitBoundsOptions)})},e.decorators=[{type:t.Directive,args:[{selector:"[leaflet]"}]}],
/** @nocollapse */
...
/** @nocollapse */
e.ctorParameters=function(){return[{type:n},{type:t.NgZone}]},e.propDecorators={layer:[{type:t.Input,args:["leafletLayer"]}]},e}(),s=/** @class */function(){function e(e,t,r){this.differs=t,this.zone=r,this.leafletDirective=new o(e),this.layersDiffer=this.differs.find([]).create()}return Object.defineProperty(e.prototype,"layers",{get:function(){return this.layersValue},
// Set/get the layers
...
/**
     ...
     */
e.prototype.updateLayers=function(){var e=this.leafletDirective.getMap();if(null!=e&&null!=this.layersDiffer){var t=this.layersDiffer.diff(this.layersValue);null!=t&&this.zone.runOutsideAngular(function(){t.forEachRemovedItem(function(t){e.removeLayer(t.item)}),t.forEachAddedItem(function(t){e.addLayer(t.item)})})}},e.decorators=[{type:t.Directive,args:[{selector:"[leafletLayers]"}]}],
/** @nocollapse */
...
/**
     ...
     */
e.prototype.syncBaseLayer=function(){var e,t=this,r=this.leafletDirective.getMap(),n=f.mapToArray(this.baseLayers);
...
/**
     ...
     */return e.createTileLayer=function(e){var t;switch(e.type){case"xyz":t=r.tileLayer(e.url,e.options);break;case"wms":default:t=r.tileLayer.wms(e.url,e.options)}return t},
/**
     ...
     */
e.createTileLayers=function(t){var r={};for(var n in t)t.hasOwnProperty(n)&&(r[n]=e.createTileLayer(t[n]));return r},
/**
     * Create a Tile Layer from the current state of this object
     *
     * @returns {TileLayer} A new TileLayer
     */
e.prototype.createTileLayer=function(){return e.createTileLayer(this)},e}();e.LeafletModule=c,e.LeafletDirective=n,e.LeafletDirectiveWrapper=o,e.LeafletTileLayerDefinition=h,Object.defineProperty(e,"__esModule",{value:!0})});

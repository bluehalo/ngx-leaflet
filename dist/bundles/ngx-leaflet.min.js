...
this.updateLayers()},e.prototype.ngOnDestroy=function(){this.layers=[]},e.prototype.updateLayers=function(){var e=this.leafletDirective.getMap();if(null!=e&&null!=this.layersDiffer){var t=this.layersDiffer.diff(this.layersValue);null!=t&&(t.forEachRemovedItem(function(t){e.removeLayer(t.item)}),t.forEachAddedItem(function(t){e.addLayer(t.item)}))}},e.decorators=[{type:t.Directive,args:[{selector:"[leafletLayers]"}]}],e.ctorParameters=function(){return[{type:n},{type:t.IterableDiffers}]},e.propDecorators={layers:[{type:t.Input,args:["leafletLayers"]}]},e}(),i=/** @class */function(){function e(){this.layersRemoved=0,this.layersChanged=0,this.layersAdded=0}return e.prototype.changed=function(){return!(0===this.layersRemoved&&0===this.layersChanged&&0===this.layersAdded)},e}(),a=/** @class */function(){function e(){}return e.prototype.getLayersControl=function(){return this.layersControl},e.prototype.init=function(e,t){var n=e.baseLayers||{},s=e.overlays||{};return this.layersControl=r.control.layers(n,s,t),this.layersControl},e.prototype.applyBaseLayerChanges=function(e){var t=new i;return null!=this.layersControl&&(t=this.applyChanges(e,this.layersControl.addBaseLayer)),t},e.prototype.applyOverlayChanges=function(e){var t=new i;return null!=this.layersControl&&(t=this.applyChanges(e,this.layersControl.addOverlay)),t},e.prototype.applyChanges=function(e,t){var r=this,n=new i;return null!=e&&(e.forEachChangedItem(function(e){r.layersControl.removeLayer(e.previousValue),t.call(r.layersControl,e.currentValue,e.key),n.layersChanged++}),e.forEachRemovedItem(function(e){r.layersControl.removeLayer(e.currentValue),n.layersRemoved++}),e.forEachAddedItem(function(e){t.call(r.layersControl,e.currentValue,e.key),n.layersAdded++})),n},e}(),l=/** @class */function(){return function(){this.baseLayers={},this.overlays={}}}(),u=/** @class */function(){function e(e,t){this.differs=t,this.leafletDirective=new s(e),this.controlLayers=new a,
// Generate differs
...
if(null!=this.overlaysDiffer&&null!=this.layersControlConfigValue.overlays){var r=this.overlaysDiffer.diff(this.layersControlConfigValue.overlays);this.controlLayers.applyOverlayChanges(r)}}},e.decorators=[{type:t.Directive,args:[{selector:"[leafletLayersControl]"}]}],e.ctorParameters=function(){return[{type:n},{type:t.KeyValueDiffers}]},e.propDecorators={layersControlConfig:[{type:t.Input,args:["leafletLayersControl"]}],layersControlOptions:[{type:t.Input,args:["leafletLayersControlOptions"]}]},e}(),y=/** @class */function(){function e(){}return e.mapToArray=function(e){var t=[];for(var r in e)e.hasOwnProperty(r)&&t.push(e[r]);return t},e}(),p=/** @class */function(){function e(e,t){this.differs=t,this.leafletDirective=new s(e),this.controlLayers=new a,this.baseLayersDiffer=this.differs.find({}).create()}/**
...
r.length>0&&(this.baseLayer=r[0],this.baseLayer.addTo(t))},e.decorators=[{type:t.Directive,args:[{selector:"[leafletBaseLayers]"}]}],e.ctorParameters=function(){return[{type:n},{type:t.KeyValueDiffers}]},e.propDecorators={baseLayers:[{type:t.Input,args:["leafletBaseLayers"]}],layersControlOptions:[{type:t.Input,args:["leafletLayersControlOptions"]}]},e}(),f=/** @class */function(){function e(){}/** @nocollapse */
return e.forRoot=function(){return{ngModule:e,providers:[]}},e.decorators=[{type:t.NgModule,args:[{exports:[n,o,u,p],declarations:[n,o,u,p]}]}],e.ctorParameters=function(){return[]},e}(),c=/** @class */function(){function e(e,t,r){this.type=e,this.url=t,this.options=r}/**

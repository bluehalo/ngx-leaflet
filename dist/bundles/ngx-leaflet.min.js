...
!function(e,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("@angular/core"),require("leaflet")):"function"==typeof define&&define.amd?define(["exports","@angular/core","leaflet"],t):t(e.ngxLeaflet={},e.ng.core,e.L)}(this,function(e,t,r){"use strict";var n=/** @class */function(){function e(e,n){this.element=e,this.zone=n,this.DEFAULT_ZOOM=1,this.DEFAULT_CENTER=r.latLng(38.907192,-77.036871),this.DEFAULT_FPZ_OPTIONS={},this.fitBoundsOptions=this.DEFAULT_FPZ_OPTIONS,this.panOptions=this.DEFAULT_FPZ_OPTIONS,this.zoomOptions=this.DEFAULT_FPZ_OPTIONS,this.zoomPanOptions=this.DEFAULT_FPZ_OPTIONS,
// Default configuration
this.options={},
// Configure callback function for the map
this.mapReady=new t.EventEmitter}/**
...
/**
     ...
     */
/** @nocollapse */
return e.prototype.ngOnInit=function(){var e=this;
...
// Fit bounds
e.fitBounds&&this.setFitBounds(e.fitBounds.currentValue)},e.prototype.getMap=function(){return this.map},e.prototype.onResize=function(){this.delayResize()},e.prototype.doResize=function(){var e=this;
// Invalidate the map size to trigger it to update itself
this.zone.runOutsideAngular(function(){e.map.invalidateSize({})})},e.prototype.delayResize=function(){null!=this.resizeTimer&&clearTimeout(this.resizeTimer),this.resizeTimer=setTimeout(this.doResize.bind(this),200)},e.prototype.setView=function(e,t){var r=this;this.map&&null!=e&&null!=t&&this.zone.runOutsideAngular(function(){r.map.setView(e,t,r.zoomPanOptions)})},e.prototype.setZoom=function(e){var t=this;this.map&&null!=e&&this.zone.runOutsideAngular(function(){t.map.setZoom(e,t.zoomOptions)})},e.prototype.setCenter=function(e){var t=this;this.map&&null!=e&&this.zone.runOutsideAngular(function(){t.map.panTo(e,t.panOptions)})},e.prototype.setFitBounds=function(e){var t=this;this.map&&null!=e&&this.zone.runOutsideAngular(function(){t.map.fitBounds(e,t.fitBoundsOptions)})},e.decorators=[{type:t.Directive,args:[{selector:"[leaflet]"}]}],e.ctorParameters=function(){return[{type:t.ElementRef},{type:t.NgZone}]},e.propDecorators={fitBoundsOptions:[{type:t.Input,args:["leafletFitBoundsOptions"]}],panOptions:[{type:t.Input,args:["leafletPanOptions"]}],zoomOptions:[{type:t.Input,args:["leafletZoomOptions"]}],zoomPanOptions:[{type:t.Input,args:["leafletZoomPanOptions"]}],options:[{type:t.Input,args:["leafletOptions"]}],mapReady:[{type:t.Output,args:["leafletMapReady"]}],zoom:[{type:t.Input,args:["leafletZoom"]}],center:[{type:t.Input,args:["leafletCenter"]}],fitBounds:[{type:t.Input,args:["leafletFitBounds"]}],onResize:[{type:t.HostListener,args:["window:resize",[]]}]},e}(),o=/** @class */function(){function e(e){this.leafletDirective=e}return e.prototype.init=function(){},e.prototype.getMap=function(){return this.leafletDirective.getMap()},e}(),i=/** @class */function(){function e(e,t){this.zone=t,this.leafletDirective=new o(e)}/** @nocollapse */
...
// Update the layer
var r=e.layer.previousValue,n=e.layer.currentValue;this.zone.runOutsideAngular(function(){null!=r&&r.remove(),null!=n&&t.leafletDirective.getMap().addLayer(n)})}},e.decorators=[{type:t.Directive,args:[{selector:"[leafletLayer]"}]}],e.ctorParameters=function(){return[{type:n},{type:t.NgZone}]},e.propDecorators={layer:[{type:t.Input,args:["leafletLayer"]}]},e}(),s=/** @class */function(){function e(e,t,r){this.differs=t,this.zone=r,this.leafletDirective=new o(e),this.layersDiffer=this.differs.find([]).create()}/**
...
n.length>0&&(this.baseLayer=n[0],this.zone.runOutsideAngular(function(){t.baseLayer.addTo(r)}))},e.decorators=[{type:t.Directive,args:[{selector:"[leafletBaseLayers]"}]}],e.ctorParameters=function(){return[{type:n},{type:t.KeyValueDiffers},{type:t.NgZone}]},e.propDecorators={baseLayers:[{type:t.Input,args:["leafletBaseLayers"]}],layersControlOptions:[{type:t.Input,args:["leafletLayersControlOptions"]}]},e}(),c=/** @class */function(){function e(){}/** @nocollapse */
return e.forRoot=function(){return{ngModule:e,providers:[]}},e.decorators=[{type:t.NgModule,args:[{exports:[n,i,s,y,p],declarations:[n,i,s,y,p]}]}],e.ctorParameters=function(){return[]},e}(),h=/** @class */function(){function e(e,t,r){this.type=e,this.url=t,this.options=r}/**
